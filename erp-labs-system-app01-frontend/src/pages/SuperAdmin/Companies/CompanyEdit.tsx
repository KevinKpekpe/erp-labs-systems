...
import { ArrowLeftIcon, TrashIcon, SaveIcon } from "../../../icons";
  ...
  const fetchCompany = async () => {
    try {
      ...
      setFormData({
        ...
        secteur_activite: companyData.secteur_activite || "",
        type_etablissement: companyData.type_etablissement || "Privé",
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow dark:shadow-gray-800 p-6">
              ...
              <div className="mt-6">
                ...
                {company.logo && !logoPreview && !removeLogo && (
