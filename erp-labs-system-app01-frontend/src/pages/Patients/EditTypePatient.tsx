...
const mockTypePatient: FormData = {
  code: "TP001",
  nom_type: "Résident",
...
export default function EditTypePatient() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Type de patient modifié:", formData);
      alert("Type de patient modifié avec succès !");
      
      // Rediriger vers la liste
      window.location.href = "/types-patients";
    } catch (error) {
      console.error("Erreur lors de la modification:", error);
      alert("Erreur lors de la modification du type de patient");
    } finally {
